(function() {
    ...
    // Busca un elemento en la página con el id "javier-chat-widget" y construye el chat dentro de él.
    //

    // ID del elemento HTML donde se renderizará el widget.
    // El usuario debe añadir <div id="javier-chat-widget"></div> en su página.
    ...
    const widgetHTML = `
        <div class="w-full max-w-[1000px] h-[700px] bg-[#F1EEE9] rounded-3xl shadow-lg px-2 py-8 flex flex-col text-stone-800 relative overflow-hidden">
            <div class="w-full max-w-2xl mx-auto flex flex-col flex-grow min-h-0 relative overflow-hidden">
                ...
                <div id="chat-thread" class="flex-grow overflow-y-auto pr-2 space-y-4 pb-6">
                ...
                <div id="history-view" class="hidden flex-grow flex flex-col pt-8 min-h-0">
                    <div class="flex items-center justify-end mb-8 px-4">
    ...
    function initializeJavierWidget() {
        ...
        if (!targetElement) {
            console.error(`Javier Widget: No se encontró el elemento contenedor con id #${WIDGET_CONTAINER_ID}.`);
            return;
        }
        ...
        // 4. --- LÓGICA DEL WIDGET (JAVASCRIPT) ---
        ...
        if (SpeechRecognition) {
            ...
            recognition.interimResults = false; // Set to false to get final result
